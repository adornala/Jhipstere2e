package com.e2e.hipster.web.rest;

import com.e2e.hipster.JhipsterE2EApp;
import com.e2e.hipster.domain.Authority;
import com.e2e.hipster.domain.User;
import com.e2e.hipster.repository.UserRepository;
import com.e2e.hipster.security.AuthoritiesConstants;
import com.e2e.hipster.service.MailService;
import com.e2e.hipster.service.UserService;
import com.e2e.hipster.service.dto.UserDTO;
import com.e2e.hipster.service.mapper.UserMapper;
import com.e2e.hipster.web.rest.errors.ExceptionTranslator;
import com.e2e.hipster.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = JhipsterE2EApp.class)
